...
public class OwnerRegister extends AppCompatActivity {
    ...
    public static final String DOGWALK_USERS = "DogWalkUsers";
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        reference = FirebaseDatabase.getInstance().getReference().child(DOGWALK_USERS).child(userId);
        ...
        LocationServices.getFusedLocationProviderClient(OwnerRegister.this)
                .requestLocationUpdates(locationRequest, new LocationCallback() {
                    ...
                    public void onLocationResult(@NonNull LocationResult locationResult) {
                        ...
                        LocationServices.getFusedLocationProviderClient(OwnerRegister.this).removeLocationUpdates(this);
                        if (locationResult != null && locationResult.getLocations().size() > 0) {
                            int latestLocationIndex = locationResult.getLocations().size() - 1;
                            latitude = locationResult.getLocations().get(latestLocationIndex).getLatitude();
                            longitude = locationResult.getLocations().get(latestLocationIndex).getLongitude();

                            DatabaseReference reference2 = FirebaseDatabase.getInstance().getReference().child(OwnerRegister.LOCATION).child(username);
                            hashMap.put("id", userId);
                            hashMap.put("username", username);
                            ...
                            Toast.makeText(OwnerRegister.this, "latitude : " + latitude, Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void sendUserToMainActivity() {
        Intent intent = new Intent(OwnerRegister.this, OwnerDashboard.class);
